...
class _StockPriceChartState extends State<StockPriceChart> {
  ...
  Future<void> loadStockPrices() async {
    final response = await http.get(
        Uri.parse(
            'https://api.polygon.io/v2/aggs/ticker/J/range/1/day/2023-01-09/2023-02-09?adjusted=true&sort=asc&limit=120&apiKey=SWzQ0CXd1pXjVkWYq4OEbROcgqcabXXZ'));
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Text('Kode Saham J', style: TextStyle(fontSize: 18)),
        ElevatedButton(
          onPressed: () {
            loadStockPrices();
          },
